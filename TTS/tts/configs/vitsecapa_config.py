## Edited version of vits_config.py, to go along with TTS.tts.models.vitsecapa (see ../models/vitsecapa.py)
...
from TTS.tts.models.vitsecapa import VitsArgs, VitsAudioConfig


@dataclass
class VitsecapaConfig(BaseTTSConfig):
